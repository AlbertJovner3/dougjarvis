      ...
      {users.map((user, index) => {
        return (
          <>
            ...
            <AboutH2>{user.name24}</AboutH2>
            <AboutP>{user.description24}</AboutP>
            <AboutP>{user.price24}</AboutP>
            <AboutH2>{user.name25}</AboutH2>
            <AboutP>{user.description25}</AboutP>
            <AboutP>{user.price25}</AboutP>
            <AboutH2>{user.name26}</AboutH2>
            <AboutP>{user.description26}</AboutP>
            <AboutP>{user.price26}</AboutP>
            <AboutH2>{user.name27}</AboutH2>
            <AboutP>{user.description27}</AboutP>
            <AboutP>{user.price27}</AboutP>
            <AboutH2>{user.name28}</AboutH2>
            <AboutP>{user.description28}</AboutP>
            <AboutP>{user.price28}</AboutP>
            <AboutH2>{user.name29}</AboutH2>
            <AboutP>{user.description29}</AboutP>
            <AboutP>{user.price29}</AboutP>
            </Dropdown>
            ) : null}
          </>
        );
